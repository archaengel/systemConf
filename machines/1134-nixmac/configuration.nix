...

{
  ...
  # Attempt to prevent overheating and poor battery life on macbook pro 14,3
  ...
  boot.extraModulePackages = [
    (pkgs.callPackage ../../packages/touchbar.nix {
      kernel = config.boot.kernelPackages.kernel;
    })
  ];

  boot.extraModprobeConfig = ''
    options apple-ib-tb idle_timeout=60 fnmode=2
  '';
  ...
  networking.hostName = "1134-nixmac"; # Define your hostname.
